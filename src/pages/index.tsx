  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Car Pool - Revolutionizing transportation with convenience and efficiency. Find, book, and track your ride in real-time. Catering to diverse needs with a wide selection of vehicles. Experience seamless car sharing."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Pool - Revolutionizing transportation with convenience and efficiency. Find, book, and track your ride in real-time. Catering to diverse needs with a wide selection of vehicles. Experience seamless car sharing.`}
            </Text>
            <Box
